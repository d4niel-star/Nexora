...
function buildProposal(
  ...
  const blocks: AIBlockOutput[] = [
    {
      ...
      settings: {
        ...
        primaryActionLink: `/store/${storeSlug}/products`,
      },
    },
    {
  ...
  return {
    ...
    hero: {
      ...
      ctaLink: `/store/${storeSlug}/products`,
    },
    blocks,
    navigation: [
      { label: "Shop All", href: `/store/${storeSlug}/products` },
      { label: "Best Sellers", href: `/store/${storeSlug}/collections/best-sellers` },
      { label: "Nosotros", href: `/store/${storeSlug}/about` },
      { label: "Tracking", href: `/store/${storeSlug}/tracking` },
    ],
