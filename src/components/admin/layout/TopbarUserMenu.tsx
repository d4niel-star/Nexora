  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="inline-flex h-11 min-h-11 items-center gap-2 rounded-[var(--r-sm)] border border-[color:var(--chrome-border)] bg-[var(--chrome-hover)] pl-1 pr-3 text-[13px] font-medium text-[var(--chrome-fg)] transition-colors hover:bg-[color:var(--chrome-border)] focus-visible:outline-none focus-visible:shadow-[var(--shadow-focus-on-dark)]"
      >
