...
const PLAN_META: Record<string, {
  ...
  free: {
    ...
    features: [
      ...
      { icon: Bot, label: "Asistente IA básico" },
  ...
  starter: {
    ...
    features: [
      ...
      { icon: Bot, label: "AI Store Studio" },
  ...
  growth: {
    ...
    features: [
      ...
      { icon: Globe, label: "Dominio personalizado" },
      { icon: Palette, label: "Branding avanzado" },
      { icon: Bot, label: "AI Store Studio completo" },
      { icon: Truck, label: "Carriers avanzados" },
      { icon: Megaphone, label: "Ads Copilot" },
  ...
  pro: {
    ...
    features: [
      ...
      { icon: Truck, label: "Carriers avanzados" },
      { icon: Megaphone, label: "Ads Copilot avanzado" },
